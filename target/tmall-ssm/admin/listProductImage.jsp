				...
				<div class="panel panel-warning addPictureDiv">
					<div class="panel-heading">新增产品<b class="text-primary"> 单个 </b>图片</div>
					  <div class="panel-body">
					    	<form method="post" class="addFormSingle" action="productImage/add.do" enctype="multipart/form-data">
					    		<table class="addTable">
					    			...
					    			<tr class="submitTR">
					    				<td align="center">
					    					...
					    					<button type="submit" class="btn btn-success" updateLink="true">提 交</button>
					    				</td>
					    			</tr>
					    		</table>
					    	</form>
						...
						<c:forEach items="${pisSingle}" var="pi">
							<tr>
								...
								<td><a deleteLink="true"
									href="productImage/delete.do?id=${pi.id}"><span
			  ...
			  <div>
				...
				<div class="panel panel-warning addPictureDiv">
					<div class="panel-heading">新增产品<b class="text-primary"> 详情 </b>图片</div>
					  <div class="panel-body">
					    	<form method="post" class="addFormDetail" action="productImage/add.do" enctype="multipart/form-data">
					    		<table class="addTable">
					    			<tr>
